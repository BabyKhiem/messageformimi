    ...
    document.getElementById("startButton").addEventListener("click", function () {
        ...
        content.innerHTML = `
            <div class="envelope-wrapper">
                <div id="envelope" class="close">
                    ...
                    <div class="letter">
                        <p class="words line1"> I love you so much. You're the best girlfriend ever! I am so thankful to have you in my life. You mean so much to me, more than you could ever know.</p>
                        <p class="words line3">-Your Future Husband</p>
                    </div>
                </div>
            </div>
            <div class="continue">
        ...
        btnContinue.addEventListener("click", function () {
            content.innerHTML = `
                ...
                <div class="question">
                    <p style="font-size: 24px;">Valentine's day is coming up and it's such a shame I don't have a Valentine yet.</p>
					<p style="font-size: 24px;">So I was wondering... Will you be my Valentine?</p>
            ...
            document.getElementById("yesBtn").addEventListener("click", function () {
                content.innerHTML = `
					<div style="text-align: center;">
						...
						<p style="font-size: 24px;">OOOUUUUWEEEE I LOVE YOU! SEE YOU SOON BABY!</p>
					</div>
                `;
            });
            ...
            noBtn.addEventListener("click", function () {
				content.innerHTML = "<div style='text-align: center;'>" +
					...
					"<p style='font-size: 24px;'> Oh hell nhawl, wrong answer. Refresh and try again before I cry.</p>" +
					"</div>";
			});
        });
    });
